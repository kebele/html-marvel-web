// thanks to Mr. Web Designer // https://www.youtube.com/c/MrWebDesignerAnas //
I rebuilt this UI using Vue.js
...
.heading span {
  color: rgb(68, 134, 209);
  font-size: 2.5rem;
}

.fa-thumbtack {
  transform: rotate(30deg) scaleY(1.6);
  padding: 0 7px;
  color: blue;
}
